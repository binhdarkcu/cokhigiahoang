...
<div class="mp-wrap">
    <ul class="mpbox <?php if(is_page('san-pham')) {echo 'col3'; } else {echo 'col4';}?>  boxed">
            ...
            <li class="mp-services tranz">
                <div class="mp-inner tranz ">
                    ...
                    <div class="mp-service-media">
                        <a href="<?php echo get_the_permalink(get_the_ID())?>"><img width="250" height="197" src="<?php echo $feature_image_meta[0] ?>" class="service-thumb wp-post-image" alt="" /></a>
                    </div>
                    <p>
                    <?php
