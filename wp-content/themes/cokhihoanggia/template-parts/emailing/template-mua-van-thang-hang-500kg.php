                  ...
                  <td align="left" valign="top">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td width="161" style="border-right: 1px solid #000; border-top: 1px solid #333; border-bottom: 1px solid #333; padding: 5px 5px 5px 3px; line-height: 1.2; font-family: Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; font-weight: bold">%don_gia_lap_dat_kiem_dinh%</td>
            ...
            <td style="border: 2px solid #ccc" align="left">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr style="border-bottom: 1px solid #ccc">
                  ...
                  <td width="70%" style="padding: 5px 5px 5px 3px; line-height: 1.2; font-family: Helvetica, Arial, sans-serif; font-size: 16px;"><strong>Giá trị thiết bị đã qua sử dụng được tính bằng %phan_tram_gia_tri_cu%% giá trị thiết bị mới.</strong></td>
                </tr>
