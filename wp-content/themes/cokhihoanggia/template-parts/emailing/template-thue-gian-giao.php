              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td align="left" valign="top">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed;" bgcolor="#ddd">
                      <tr>
                        <td width="555" style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 5px 5px 5px 3px; line-height: 1.2; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left;font-weight: bold;">Vận chuyển đi và về công trình (%don_gia_van_chuyen% vnđ/kg/lượt x Khối lượng thực tế)</td>
